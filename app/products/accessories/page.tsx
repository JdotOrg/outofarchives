...
import { Filter, Grid3X3, List, SearchIcon, Heart } from 'lucide-react'
...
export default function AccessoriesPage() {
  ...
  // Accessories data - in a real app, this would come from an API/backend
  const products = [
    {
      id: 4,
  ...
  const updateUrlParams = () => {
    ...
    router.push(queryString ? `?${queryString}` : "/products/accessories", { scroll: false })
  }
    ...
    <div className="max-w-7xl mx-auto px-4 py-10 md:px-6 md:py-16">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Stickers and More</p>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    {product.category === "Stickers" 
                      ? "High-quality vinyl stickers featuring our iconic Menguin mascot design. Waterproof and durable for laptops, water bottles, and more."
                      : "Premium accessories featuring our iconic Menguin mascot design. Made with sustainable materials and attention to detail."}
                  </p>
                </div>
